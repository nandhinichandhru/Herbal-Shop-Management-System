...
.go-back-btn:hover {
  ...
  <script>
    ...
    function loadFormAndTable(tableName, formUrl) {
      ...
      if (formUrl) {
        formContainer.innerHTML = `<iframe src="${formUrl}" onload="showViewDashboardButton()"></iframe>`;
      } else {
        formContainer.innerHTML = `<h3>You can view this table, but it doesn't require any input.</h3>`;
      }
    ...
    function viewDashboard() {
      ...
      goBackBtn.style.display = "block"; // Show Go Back button when dashboard is shown
    ...
    function goBackToForm() {
      ...
      // Hide the dashboard and go back to the form
      dashboardContainer.style.display = "none";
      formContainer.style.display = "block";
      viewDashboardBtn.style.display = "block"; // Show the "View Dashboard" button again
